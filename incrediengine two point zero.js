    ...
    class IncrediEngine2point0 {
            ...
            return {
                ...
                blocks: [
...

                    {
                        ...
                        text: 'create character json using id [ID] category [CATEGORY] order [ORDER] max volume [VOLUME] page [PAGE]',
                        arguments: {
                            ID: {
                    ...
                    },
                    {
                        ...
                        text: 'register chararacter with data [CHAR]',
                        arguments: {
                            CHAR: {
                    ...
                    '---',
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get [PROPERTY] of character [ID]',
                        arguments: {
                            PROPERTY: {
                                type: Scratch.ArgumentType.STRING,
                                menu: 'CHAR_PROPS'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'set custom property [KEY] of character [ID] to [VALUE]',
                        arguments: {
                            KEY: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'color'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get custom property [KEY] of character [ID]',
                        arguments: {
                            KEY: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'color'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: '[ACTION] character [ID] using solo mode [UNSOLO_MODE]',
                        arguments: {
                            ACTION: {
                                type: Scratch.ArgumentType.STRING,
                                menu: 'SOLO_ACTIONS'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get currently soloed character'
                    },
                    '---',
                    {
                        ...
                        allowDropAnywhere: true,
                        text: 'get all characters in [CATEGORY] on page [PAGE]',
                        arguments: {
                            CATEGORY: {
                                type: Scratch.ArgumentType.STRING,
                                menu: 'CATEGORY_MENU'
                    ...
                    },
                    {
                        ...
                        blockShape: Scratch.BlockShape.SQUARE,
                        allowDropAnywhere: true,
                        text: 'get all characters in [CATEGORY] on page [PAGE] sorted by order',
                        arguments: {
                            CATEGORY: {
                                type: Scratch.ArgumentType.STRING,
                                menu: 'CATEGORY_MENU'
                    ...
                    },
                    {
                        ...
                        blockShape: Scratch.BlockShape.SQUARE,
                        allowDropAnywhere: true,
                        text: 'get all character IDs on page [PAGE]',
                        arguments: {
                            PAGE: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'page1'
                    ...
                    '---',
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'place character [CHARACTER] on slot [SLOT]',
                        arguments: {
                            CHARACTER: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'character'
                    ...
                    },
                    {
                        ...
                        text: 'replace character on slot [SLOT] with [CHARACTER]',
                        arguments: {
                            SLOT: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'slot1'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'remove character [CHARACTER] from its slot',
                        arguments: {
                            CHARACTER: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'character'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'remove occupant from slot [SLOT]',
                        arguments: {
                            SLOT: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'slot1'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'remove all characters from slots'
                    },
                    '---',
                    {
                        opcode: 'slotIsOccupied',
                        blockType: Scratch.BlockType.BOOLEAN,
                        text: 'is slot [SLOT] is occupied?',
                        arguments: {
                            SLOT: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'slot1'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get occupant of slot [SLOT]',
                        arguments: {
                            SLOT: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'slot1'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'set custom property [KEY] of slot [SLOT] to [VALUE]',
                        arguments: {
                            KEY: {
                                type: Scratch.ArgumentType.STRING,
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get custom property [KEY] of slot [SLOT]',
                        arguments: {
                            KEY: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'position'
                    ...
                    },
                    {
                        ...
                        blockShape: Scratch.BlockShape.SQUARE,
                        allowDropAnywhere: true,
                        text: 'get all occupied slot IDs'
                    },
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.BOOLEAN,
                        text: 'does category [CATEGORY] exists?',
                        arguments: {
                            CATEGORY: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'beats'
...

                    {
                        ...
                        blockShape: Scratch.BlockShape.PLUS,
                        allowDropAnywhere: true,
                        text: 'generate loop json with  ID [ID] BPM [BPM] bars [BARS] beats/bar [BPB]',
                        arguments: {
                            ID: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'loop1'
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get [PROPERTY] of loop [LOOP]',
                        arguments: {
                            PROPERTY: {
                                type: Scratch.ArgumentType.STRING,
                                menu: 'LOOP_PROPS'
                    ...
                    },
                    {
                        ...
                        blockShape: Scratch.BlockShape.PLUS,
                        allowDropAnywhere: true,
                        text: 'get current loop'
                    },
                    {
                        opcode: 'getCurrentBeat',
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get current beat'
                    },
                    {
                        opcode: 'getCurrentBar',
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get current bar'
                    },
                    {
                        opcode: 'getLoopProgress',
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get loop progress %'
                    },
                    {
                        opcode: 'getTimeUntilNextBeat',
                        blockType: Scratch.BlockType.REPORTER,
                        allowDropAnywhere: true,
                        text: 'get seconds until next beat'
                    },
                    {
                        opcode: 'waitForNextBeat',
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'get wait for next beat'
                    },
                    '---',
                    {
                        opcode: 'whenBeat',
                ...
                menus: {
                    ...
                    LOOP_PROPS: {
                        acceptReporters: true,
                        items: ['id', 'bpm', 'bars', 'beats per bar', 'length in seconds', 'length in beats', 'length per beat', 'sidechain volume']
                    },
                    MUTE_ACTIONS: {
                        acceptReporters: true,
        ...
        getLoopProperty({
            ...
            switch (Cast.toString(PROPERTY)) {
                ...
                case 'sidechain volume':
                    return (((this.internalTimer ?? + 0.02) / data.lengthInBeats) % 1) ?? 0;
                default:
                    return ''
            }
        }
